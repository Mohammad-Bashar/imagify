...
navigate('/result')
  ...
  return (
    ...
    viewport={{once:true}}>
      <motion.div className='text-stone-700 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'
    ...
    animate={{opacity:1}}
     className='flex flex-wrap justify-center mt-16 gap-3'>
        ...
        <motion.img 
        whileHover={{scale:1.55,duration:0.1}}
