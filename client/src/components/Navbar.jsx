  ...
  return (
    ...
    <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={() =>navigate('/Buycredit')} className='flex items-center gap-2 bg-blue-100 px-2 sm:px-3 py-1 sm:py-1 rounded-full hover:scale-105 transition-all duration-700'>
                <img className='w-5 h-5' src={assets.credit_star} alt=""/>
